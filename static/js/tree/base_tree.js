...
D3BaseTree.prototype._changeCategory=function(category){
	...
	for (var colour_count in cat_count_list){
		...
		if (cust_col && cust_col[val]){
			...
			this.category_colours[val]=this.legend_colours[colour_count % cat_count_list.length];
			cat_count_list[colour_count][2] = this.legend_colours[colour_count % cat_count_list.length];
		} else {
