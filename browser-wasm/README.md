...
RapidNJ 2.2.3 is also compiled to WASM from pinned GPL-2 source distributed
alongside the binary; standard NJ uses a small browser-native implementation.
...
The shared Playwright fixtures check MSTree, MSTreeV2, NJ, RapidNJ, every
missing-data mode, the full issue #82 technical-replicate input, the
